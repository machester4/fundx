...
import { generateDailyReport } from "../../services/reports.service.js";
import { SuccessMessage } from "../../components/SuccessMessage.js";

export const description = "Generate daily report";
...
export default function ReportDaily({ args: [fundName] }: Props) {
  ...
  return <SuccessMessage>Daily report saved: {path}</SuccessMessage>;
}
